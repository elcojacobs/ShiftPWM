/******************************************************************************
 * This example for ShiftPWM shows how to control your LED's in a non-blocking
 * way: no delay loops.
 * This example receives a number from the serial port to set the fading mode.
 * Instead you can also read buttons or sensors.
 * 
 * ShiftPWM non-blocking example with SPI, (c) Elco Jacobs, July 2012.
 * 
 *****************************************************************************/
